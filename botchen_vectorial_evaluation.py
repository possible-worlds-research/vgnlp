...
def evaluation_with_vectorial_space(module, language, topk,
    ...
    for script_id_optimal in range(0, 13):
        print('Optimal script', script_id_optimal)
        ...
        if evaluating_framework == 1:  # Fill up the dimensionalities
            print('Fill up dimensionalities evaluation')
            ...
            # print('AVERAGE ROW SIMILARITY', row_similarity_df.values.mean())
            # print((optimal_df.to_numpy() == aligned_evaluation_df.to_numpy()).all()
            ...
            # print(row_diagonal_series)
            print('MEAN ROW SIMILARITY', "{:.3f}".format(row_diagonal_series.values.mean()))
            row_5_highest = row_diagonal_series.nlargest(5)
            print('Most similar rows:', row_5_highest)
            ...
            # print(col_diagonal_series
            print('MEAN COL SIMILARITY', "{:.3f}".format(col_diagonal_series.values.mean()))
            col_5_highest = col_diagonal_series.nlargest(5)
            print('Most similar cols:', col_5_highest)

        elif evaluating_framework == 2:  # Only match dimensions

            print('Retraction evaluation')
            ...
            row_diagonal_series = pd.Series(row_diagonal_values, index=row_similarity_df.index)
            # print(row_diagonal_series)
            print('Average similarity diagonal cells - row', row_diagonal_series.values.mean())
            row_5_highest = row_diagonal_series.nlargest(5)
            print('Most similar rows:', row_5_highest)
            ...
            col_diagonal_series = pd.Series(col_diagonal_values, index=column_similarity_df.index)
            # print(col_diagonal_series
            print('Average similarity diagonal cells - cols', col_diagonal_series.values.mean())
            col_5_highest = col_diagonal_series.nlargest(5)
            print('Most similar rows:', col_5_highest)

        elif evaluating_framework == 3:  # RSA-based evaluation
            print('RSA evaluation')
